...
Begin VB.Form frmThumbs 
   ...
   Begin MSComctlLib.ImageList imlTools 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Thumbs.frx":13DE
            Key             =   "Browse"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Thumbs.frx":177A
            Key             =   "Select"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Thumbs.frx":227C
            Key             =   "Exit"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Thumbs.frx":2618
            Key             =   "Refresh"
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList imlToolsHover 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Thumbs.frx":29B4
            Key             =   "Browse"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Thumbs.frx":2D50
            Key             =   "Select"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Thumbs.frx":2FB7
            Key             =   "Exit"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Thumbs.frx":3353
            Key             =   "Refresh"
         EndProperty
      EndProperty
   End
...
Dim Test As Long
    ...
    lblCount.Caption = "Images: " & Format$(lFilCnt, "#,##0")
    If Len(sPath) > 0 Then
        Call StartProgress
        For lIdx = 0 To filHidden.ListCount - 1
            ...
            ElseIf InStr(1, LCase$(filHidden.List(lIdx)), ".png") > 0 Then
                Test = png.OpenPNG(sPath & filHidden.List(lIdx))
...
Private Sub optThumb_DblClick(Index As Integer)
    ...
    Call tbrMain_ButtonClick(tbrMain.Buttons("Select"))
